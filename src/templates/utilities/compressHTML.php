...
/**
 * HTML圧縮処理クラス
 * @url https://zuziko.com/tutorials/how-to-minify-html-in-wordpress-without-a-plugin/
 */
class compressHTML
{
    protected bool $flhm_compress_css = true;
    protected bool $flhm_compress_js = true;
    protected bool $flhm_info_comment = true;
    protected bool $flhm_remove_comments = true;
    protected $html;
